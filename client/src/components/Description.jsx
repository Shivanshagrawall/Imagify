  ...
  return (
    ...
    className="flex flex-col justify-center items-center my-24 p-6 md:px-28">
      ...
      <div className="flex flex-col gap-5 md:gap-14 md:flex-row items-center">
        ...
        />
        <div>
          <h2 className="text-3xl font-medium max-w-lg mb-4">Intoduction of AI-Powered Text to Image Generator</h2>
          <p className="text-gray-600 mb-4">
            Easily bring your ideas to life with our free AI Image Generator.
            Whether you needs stunning visuals or unique imagery, our tool
          ...
          <p className="text-gray-600 ">
            ...
            design and portraits even concept that doesn't even exists can be
            visualized effortlessly. Powered by Advanced AI Technology, the
            creative Probability are limitless!
          </p>
        </div>
      </div>
    </motion.div>

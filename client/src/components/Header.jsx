...
const Header = () => {
  ...
  return (
    <motion.div className="flex flex-col items-center justify-center my-20 text-center"
    ...
    viewport={{once:true}}>     
      ...
      <motion.h1 className="text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center">
        {" "}
        Turn texts to <span className="text-blue-600"
        initial={{opacity:0}}
        animate={{opacity:1}}
      ...
      initial={{opacity:0}}
      animate={{opacity:1}}
      transition={{default:{duartion:0.5 }, opacity:{duration:1, delay:0.8}}}
